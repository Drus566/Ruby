...
class TestWordPlay < Minitest::Test
    ...
    # That test multiple sentence blocks are split up into individual
    # words correctly
    def test_sentences
    ...
    def test_sentence_choice
        assert_equal('This is a great test', 
            WordPlay.best_sentences['This is a test','This is another test', 'This is a great test'], %w{test great this}))

...
class BotServlet < WEBrick::HTTPServlet::AbstractServlet
    ...
    # and text entry box for the user to coverse with our bot. It uses
    ...
    def do_GET(request, response)
        ...
        # If the user supplied some text, respond to its
...
# accessible via http://localhost1234/ or http://127.0.0.1:1234/
